    ...
    return (
        <>
            <div className="w-full bg-gray-50 h-screen">
                {
                    toggle == "on" ?
                        <div className="fixed top-[0px] left-[0px] w-[150px] cursor-pointer bg-gray-600 h-screen transition-[width] duration-700 z-10">
                        ...
                        <div className="fixed top-[0px] left-[0px] w-[60px] cursor-pointer bg-gray-600 h-screen transition-[width] duration-700 z-10">
                            <div className="relative left-[10px] top-[10px]" onClick={() => changeToggle()}>
                                <div className="mb-[3px] w-[25px] h-[5px] bg-yellow-400"></div>
                                <div className="mb-[3px] w-[25px] h-[5px] bg-yellow-400"></div>
                                <div className=" w-[25px] h-[5px] bg-yellow-400"></div>
                ...
                <div className="grid grid-cols-2 fixed w-full top-[5px]">
                    ...
                    <div className="flex">
                        <h1 className="font-bold text-md text-[#222426] ml-[80px]  mt-[20px]">StackQ AI</h1>
