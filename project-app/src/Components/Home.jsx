...
export default function Home() {
  return (
    <>
      ...
      <div className="fixed top-[0px] w-full h-16 grid grid-cols-2 bg-stone-700 ">
        <div className="flex">
          ...
          <Link to="/"><h1 className="text-xl font-sans font-sm text-[#F48024] m-2 pl-3 lg:text-3xl lg:font-md">StackQ AI</h1></Link>
        </div>

        <div className="justify-self-end">
          <Link to="/login" className="bg-green-600 text-md m-2 p-2 relative top-3 rounded-md lg:text-lg">Log In</Link>
          <Link to="/signup" className="bg-orange-200 text-md m-2 p-2 relative top-3 rounded-md lg:text-lg">Sign Up</Link>
        </div>
