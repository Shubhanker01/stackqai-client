...
export default function Navbar() {
    <div className="fixed w-full h-[3.5rem] grid grid-cols-2 bg-black">
        <div className="flex">
            ...
            <Link to="/"><h1 className="text-xl font-sans font-medium text-[#F48024] m-2 pl-3">StackQ AI</h1></Link>
        </div>
